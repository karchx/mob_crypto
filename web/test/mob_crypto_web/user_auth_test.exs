defmodule MobCryptoWeb.UserAuthTest do
  use MobCryptoWeb.ConnCase, async: true

  alias MobCrypto.Accounts
  alias MobCrypto.Accounts.Scope
  alias MobCryptoWeb.UserAuth

  import MobCrypto.AccountsFixtures

  @remember_me_cookie "_mob_crypto_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MobCryptoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
